...
def main():
    print("="*70)
    print("GO2SE Genius v2.9.1 - 30天回测")
    print("普通模式 vs 专家模式")
    print("="*70)
    ...
    configs = [
        # 普通模式
        {'mode':'normal','leverage':1.0,'position_size':0.15,'buy_th':22,'sell_th':78,'position_ratio':0.35,'rebalance_th':0.12},
        {'mode':'normal','leverage':1.0,'position_size':0.2,'buy_th':20,'sell_th':80,'position_ratio':0.4,'rebalance_th':0.1},
        {'mode':'normal','leverage':1.5,'position_size':0.15,'buy_th':22,'sell_th':78,'position_ratio':0.35,'rebalance_th':0.12},
        {'mode':'normal','leverage':2.0,'position_size':0.15,'buy_th':20,'sell_th':80,'position_ratio':0.4,'rebalance_th':0.1},
        {'mode':'normal','leverage':2.0,'position_size':0.2,'buy_th':18,'sell_th':82,'position_ratio':0.45,'rebalance_th':0.08},
        # 专家模式
        {'mode':'expert','leverage':2.0,'position_size':0.25,'buy_th':18,'sell_th':82,'position_ratio':0.5,'rebalance_th':0.08},
        {'mode':'expert','leverage':2.0,'position_size':0.3,'buy_th':15,'sell_th':85,'position_ratio':0.5,'rebalance_th':0.08},
        {'mode':'expert','leverage':3.0,'position_size':0.25,'buy_th':18,'sell_th':82,'position_ratio':0.45,'rebalance_th':0.08},
        {'mode':'expert','leverage':3.0,'position_size':0.3,'buy_th':15,'sell_th':85,'position_ratio':0.5,'rebalance_th':0.08},
        {'mode':'expert','leverage':5.0,'position_size':0.2,'buy_th':18,'sell_th':82,'position_ratio':0.4,'rebalance_th':0.1},
        {'mode':'expert','leverage':5.0,'position_size':0.25,'buy_th':15,'sell_th':85,'position_ratio':0.5,'rebalance_th':0.08},
    ]
...
""")
    ...
    with open('/tmp/backtest_v291.json', 'w') as f:
