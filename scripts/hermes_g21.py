#!/usr/bin/env python3
"""
G21 - 最终版 (TradingAgents研究 + G20执行)
经过充分测试,结论:保持G20核心,简化情绪层

注意: 回测显示G20(+20.9%) > G21各种优化版本
G21保留作为TradingAgents研究接口,实际执行仍用G20
"""
...
def main():
    print("=" * 70)
    print("G21 - TradingAgents研究 + G20执行")
    print("=" * 70)
    
    signals = []
    
    for coin, params in G20_PARAMS.items():
    ...
    # 保存信号
    with open('/home/goose/.openclaw/workspace/logs/g21_signals.json', 'w') as f:
